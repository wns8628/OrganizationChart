...
public class SearchService {
	...
	public List<EmployeesVo> Employeelist(String kwd, String selectSearch, String langCode, Integer pageNo) {
		 ...
		 * 
		 * vo.setTotalboardcount(totalboardcount); vo.setTotalpage(totalpage);
		 * 
		 * vo.setStartboard(startboard); vo.setManyboard(manyboard);
		 * 
		 * vo.setPageNo(pageNo); vo.setStartPage(startPage); vo.setEndPage(endPage); //
		 * vo.setType(type); vo.setKwd(kwd+"%");
		 */
