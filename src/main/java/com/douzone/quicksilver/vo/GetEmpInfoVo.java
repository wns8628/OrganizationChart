...
public class GetEmpInfoVo {
	...
	public String toString() {
		return "GetEmpInfoVo [loginId=" + loginId + ", empNameKR=" + empNameKR + ", empNameEn=" + empNameEn
				+ ", deptName=" + deptName + ", compName=" + compName + ", mainWork=" + mainWork + ", emailAddr="
				+ emailAddr + ", position=" + position + ", duty=" + duty + ", homeTelNum=" + homeTelNum
